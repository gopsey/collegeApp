...
public class CalendarAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (day_string.get(position).equals(curentDateString)) {
            ...
            v.setBackgroundColor(Color.parseColor("#AB47BC"));
            dayView.setTextColor(Color.WHITE);
        } else {
    ...
    private void setEventView(View v, int pos, TextView txt){
        ...
        for (int i = 0; i < len; i++) {
            CalendarCollection cal_obj= (CalendarCollection) CalendarCollection.date_collection_arr.get(i);
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (date.equals(event_date)) {
                ...
                new AlertDialog.Builder(context)
                        .setIcon(R.drawable.ic_event_black_24dp_xhdpi)
